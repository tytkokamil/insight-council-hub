...
const BottleneckIntelligence = () => {
  ...
  return (
    <AppLayout>
      ...
      {/* Person Bottlenecks */}
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="glass-card p-5 mb-4">
      ...
      {/* Category Bottlenecks */}
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} className="glass-card p-5 mb-4">
        <div className="flex items-center gap-2 mb-4">
