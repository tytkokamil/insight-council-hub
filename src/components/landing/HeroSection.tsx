      ...
      <motion.div style={{ y: contentY }} className="container relative z-10 mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <Link
              to="/auth"
              className="group relative inline-flex items-center justify-center gap-2 text-[14px] font-semibold text-white px-8 py-3.5 rounded-xl transition-all duration-300 overflow-hidden"
              style={{
            ...
            <button
              ...
              className="group inline-flex items-center justify-center gap-2 text-[14px] font-medium border border-border/50 hover:border-border/80 bg-white/60 backdrop-blur-sm px-7 py-3.5 rounded-xl transition-all duration-200 hover:shadow-sm"
