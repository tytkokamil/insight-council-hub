  ...
  return (
    <AnimatePresence>
      {visible && (
        ...
        >
          <button onClick={() => accept("essential")} className="absolute top-3 right-3 text-muted-foreground hover:text-foreground" aria-label="Schließen">
            <X className="w-4 h-4" />
          </button>
          <div className="flex items-start gap-3">
            <Cookie className="w-5 h-5 text-warning shrink-0 mt-0.5" />
            <div className="space-y-3">
              <p className="text-sm text-foreground font-medium">Cookie-Einstellungen</p>
              <p className="text-xs text-muted-foreground leading-relaxed">
                Wir verwenden essentielle Cookies für den Betrieb der Plattform. Optionale Cookies helfen uns, die Nutzung zu analysieren und das Erlebnis zu verbessern.{" "}
