...
const teamTemplates = [
  {
    ...
    decisions: [
      ...
      { title: "Vendor Lock-in Bewertung AWS", description: "Risikobewertung AWS-Abhängigkeit. Multi-Cloud vs. Single-Cloud.", status: "review", priority: "medium", category: "technical", dueInDays: 6, createdDaysAgo: 8, ai_risk_score: 55, ai_impact_score: 65 },
      ...
      { title: "A/B Testing Framework", description: "Systematische A/B Tests für Conversion-Optimierung.", status: "approved", priority: "medium", category: "technical", dueInDays: 11, createdDaysAgo: 6, ai_risk_score: 15, ai_impact_score: 55 },
      { title: "Backup & Disaster Recovery Plan", description: "RTO/RPO Definition und automatisierte Backup-Strategie.", status: "approved", priority: "critical", category: "technical", dueInDays: 3, createdDaysAgo: 8, ai_risk_score: 60, ai_impact_score: 85 },
